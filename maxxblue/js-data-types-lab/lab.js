...
//i think strings were the easiest because they are just text and have a lot of built-in methods that are easy to understand and use.

//2. Which one was most confusing?
//i think objects were the most confusing because they can hold multiple key-value pairs and it can be tricky to understand how to access and manipulate the data within them.

//3. How do arrays and objects differ?
//Arrays are ordered lists of values accessed by index, while objects are collections of key-value pairs accessed by keys. Arrays are typically used for lists of items, while objects are used to represent more complex data structures with named properties.

//4. When would you use each in real applications?
//You would use arrays when you need to store a list of items, such as a list of students or products. You would use objects when you need to represent more complex data with multiple properties, such as a user profile with name, age, and email.
